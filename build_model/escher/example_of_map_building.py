...
ecoli_model = load_model("textbook")
...
ecoli_model.objective = objective
ecoli_model.objective_direction = 'max'
ecoli_model.reactions.get_by_id(objective).upper_bound = 1000
solution = ecoli_model.optimize()
print('Flux of',objective, solution.objective_value)

# The flux for each reaction is stored as a dictionary (x_dict) in the model
# turn solution.fluxes into a dictionary with reaction ids as keys and fluxes as values
# for rxn in ecoli_model.reactions:
#     print(rxn.id, solution.fluxes[rxn.id])
flux = {rxn.id: solution.fluxes[rxn.id] for rxn in ecoli_model.reactions}
...
common_mets = {'nadh_c','h2o_c','nad_c','o2_c','h_e','q8h2_c','accoa_c','q8_c','accoa_c', 'pry_c', 'g3p_c', 'acald_c', 'f6p_c', 'nadph_c','oaa_c','pep_c','pyr_c','r5p_c','adp_c','coa_c','h_c','nadp_c','pi_c','atp_c','e4p_c','f6p_c','g3p_c','g6p_c','gln__L_c','glu__L_c'}
rxn_with_flux = set()
