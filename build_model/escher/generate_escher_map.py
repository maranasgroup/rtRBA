                    ...
                    if (target.node_id, conn.reaction_name) in vertx_displacement.keys():
                        ...
                        for pos in side_positions:
                            if pos not in occupied_pos:
                                ...
                                print('Placed:',target.name, conn.reaction_name)
                                break
                            else:
                                # raise ValueError("Couldn't find position for side met " + met.name)  
                                print("Couldn't find position for side met " + met.name)
                                # put it in last tested position if no unoccupied ones found
                                met.grid_xy = pos
                                occupied_pos.append(pos)
                                print('Placed:',target.name, conn.reaction_name)
                    else:
