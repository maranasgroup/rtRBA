...
demand(j)
$include "%model_root_path%GAMS/model/RBA_rxns_demand.txt"
;
...
* undo biomass bounds
v.lo(j)$rxns_biomass(j) = 0;
v.up(j)$rxns_biomass(j) = 1e3 * %nscale%;
...
Model rba
/Obj, Stoic, RiboCapacityNuc, ProData, Nonmodel
/;
rba.optfile = 1;
